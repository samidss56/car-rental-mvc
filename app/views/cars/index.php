...
<body>
            ...
            <tbody class="text-center">
                ...
                foreach ($data['mobil'] as $mobil) {
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="../app/assets/cars/<?= $mobil['link_gambar_mobil'] ?>" alt="" width="160px"
                                height="100px" class="object-fit-cover">
                        </td>
                        <td>
                            <button class="btn btn-warning" data-bs-toggle="modal"
                                data-bs-target="#editModal<?= $mobil['mobil_id'] ?>">Edit</button>
                            <div class="modal fade" id="editModal<?= $mobil['mobil_id'] ?>" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-start">
                                            <form action="<?= BASE_URL; ?>/cars/updateMobil" method="post"
                                                enctype="multipart/form-data">
                                                <div class="form-group my-2">
                                                    <label for="mobil_id">ID Mobil</label>
                                                    <input type="text" class="form-control" id="mobil_id" name="mobil_id"
                                                        readonly value="<?= $mobil['mobil_id'] ?>">
                                                </div>
                                                <div class="form-group my-2">
                                                ...
                                                <div class="form-group my-2">
                                                    ...
                                                    <input type="number" class="form-control" id="tahun_pembuatan"
                                                        name="tahun_pembuatan" value="<?= $mobil['tahun_pembuatan'] ?>">
                                                </div>
                                                <div class="form-group my-2">
                                                    <label for="plat_nomor">Plat Nomor</label>
                                                    <input type="text" class="form-control" id="plat_nomor"
                                                        name="plat_nomor" value="<?= $mobil['plat_nomor'] ?>">
                                                </div>
                                                <div class="form-group my-2">
                                                    <label for="harga_sewa_per_hari">Harga Sewa / Hari</label>
                                                    <input type="number" class="form-control" id="harga_sewa_per_hari"
                                                        name="harga_sewa_per_hari"
                                                        value="<?= $mobil['harga_sewa_per_hari'] ?>">
                                                </div>
                                                <hr class="hr">
                                                <?php
                                                if ($mobil['link_gambar_mobil'] == null || $mobil['link_gambar_mobil'] == '' || !isset ($mobil['link_gambar_mobil'])) {
                                                    ...
                                                    <div class="text-center rounded-circle  mt-4 mb-3">
                                                        <img src="../app/assets/cars/<?= $mobil['link_gambar_mobil'] ?>" alt=""
                                                ...
                                                <div class="form-group my-2">
                                                    ...
                                                    <input type="file" class="form-control" id="link_gambar_mobil"
                                                        name="link_gambar_mobil">
                                                </div>
                                        </div>
                            ...
                            <button href="" class="btn btn-danger" data-bs-toggle="modal"
                                data-bs-target="#deleteModal<?= $mobil['mobil_id'] ?>">Delete</button>
                            <div class="modal fade" id="deleteModal<?= $mobil['mobil_id'] ?>" tabindex="-1" role="dialog"
                                aria-labelledby="judulModal" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="<?= BASE_URL; ?>/cars/deleteMobil" method="post">
                                                <input type="text" name="mobil_id" value=" <?= $mobil['mobil_id'] ?>"
                                                    hidden>
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="judulModal"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="<?= BASE_URL; ?>/cars/tambahMobil" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group my-2">
                            <label for="link_gambar_mobil">Gambar Mobil</label>
                            <input type="file" class="form-control" id="link_gambar_mobil" rows="5"
                                name="link_gambar_mobil">
                            <!-- <input type="text" class="form-control" id="link_gambar_mobil" name="link_gambar_mobil"> -->
                        </div>
                </div>
                <div class="modal-footer">
